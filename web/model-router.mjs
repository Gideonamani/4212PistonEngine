...
const registry=await fetch('./models.json?v=20260912-lesson-ready-3').then(response=>{if(!response.ok)throw Error('Training model registry unavailable');return response.json()});
...
if(model.adapter==='cylinder')await import('./viewer.js?v=20260912-lesson-ready-3');
else await import('./engine-training-adapter.mjs?v=20260912-lesson-ready-3');
